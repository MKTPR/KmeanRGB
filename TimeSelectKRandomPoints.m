function [mark] = TimeSelectKRandomPoints(specifiedFunctionName)
% Times the SelectKRandomPoints function
%
...
%
% Time SelectKRandomPoints by running it 500,000 times
% Timing standards are based on execution time when code is run on the
% university lab machines
% Timing will be done by testing 500,000 calls three times and averaging the
% result
% Note you can only earn timing marks if your SelectKRandomPoints function
% earned full functionality marks, i.e. you need a working SelectKRandomPoints
...
try
    ...
    for i=1:3
        ...
        for j =1:5000
            ...
            %disp([num2str(j*100) 'points processed']);
        end
